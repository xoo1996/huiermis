...
public class FeeForm extends ActionForm {
	...
	private Integer startyear;// 年
	private Integer endYear;// 打印客户费用结束年份
	private Integer startMonth;// 打印客户费用开始月份
	private Integer endMonth;// 打印客户费用结束月份
	...
	private Double feeothersb; // 以内其他费用
	...
	private Double feeothercharges;//其他费用(不可控)
	private Double fee1othercharges;//其他费用(可控)
	...
	private Double bfeeothercharges;//其他费用(不可控)
	...
	private Double ffee1othercharges;//其他费用(可控)
	...
	private Double nfeeothercharges;//其他费用（可控）
	private Double nfee1othercharges;//其他费用(不可控)
	...
	private Date builtStart;
	private Date builtEnd;
	private Date transStart;
	private Date transEnd;
	private Date assetsStart;
	private Date assetsEnd;

	private String amotype;
	private Date operDate;
	private String feeRentNote;
	private String feeOpenNote;
	private String feeBuiltNote;
	private String feeTransNote;
	private String feeAssetsNote;
	...
	public String getFeeRentNote() {
		return feeRentNote;
	}

	public void setFeeRentNote(String feeRentNote) {
		this.feeRentNote = feeRentNote;
	}

	public String getFeeOpenNote() {
		return feeOpenNote;
	}

	public void setFeeOpenNote(String feeOpenNote) {
		this.feeOpenNote = feeOpenNote;
	}

	public String getFeeBuiltNote() {
		return feeBuiltNote;
	}

	public void setFeeBuiltNote(String feeBuiltNote) {
		this.feeBuiltNote = feeBuiltNote;
	}

	public String getFeeTransNote() {
		return feeTransNote;
	}

	public void setFeeTransNote(String feeTransNote) {
		this.feeTransNote = feeTransNote;
	}

	public String getFeeAssetsNote() {
		return feeAssetsNote;
	}

	public void setFeeAssetsNote(String feeAssetsNote) {
		this.feeAssetsNote = feeAssetsNote;
	}
	...
	public Date getBuiltStart() {
		return builtStart;
	}

	public void setBuiltStart(Date builtStart) {
		this.builtStart = builtStart;
	}

	public Date getBuiltEnd() {
		return builtEnd;
	}

	public void setBuiltEnd(Date builtEnd) {
		this.builtEnd = builtEnd;
	}
	...
	public Date getAssetsStart() {
		return assetsStart;
	}

	public void setAssetsStart(Date assetsStart) {
		this.assetsStart = assetsStart;
	}

	public Date getAssetsEnd() {
		return assetsEnd;
	}

	public void setAssetsEnd(Date assetsEnd) {
		this.assetsEnd = assetsEnd;
	}
