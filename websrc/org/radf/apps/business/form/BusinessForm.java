...
public class BusinessForm extends ActionForm {
	...
	private Integer ivtyearEnd;//结束年份
	...
	private Date start;//销售开始日期
	private Date end;//销售结束日期
	private Date stui;//退机开始日期
	private Date etui;//退机结束日期
	...
	//赠送电池查询
	private String bb;//电池品牌
	private String bm;//电池名称
	...
	public String getGctcom() {
		return gctcom;
	}

	public void setGctcom(String gctcom) {
		this.gctcom = gctcom;
	}

	public Integer getIvtmonths() {
		return ivtmonths;
	}

	public void setIvtmonths(Integer ivtmonths) {
		this.ivtmonths = ivtmonths;
	}

	public Integer getIvtmontht() {
		return ivtmontht;
	}

	public void setIvtmontht(Integer ivtmontht) {
		this.ivtmontht = ivtmontht;
	}
	...
	public String getRepfee() {
		return repfee;
	}

	public void setRepfee(String repfee) {
		this.repfee = repfee;
	}
	...
	public Integer getIvtyearEnd() {
		return ivtyearEnd;
	}

	public void setIvtyearEnd(Integer ivtyearEnd) {
		this.ivtyearEnd = ivtyearEnd;
	}
	...
	private Integer websource;//网络来源人数
	private Integer websell;//网络销售人数
	private Integer webnum;//网络销售台数
	private Double webcvt;//总部转诊
	private Double weblocal;//地方网络
	private Double webtotal;//合计网络销售
	private Double webrate;//占当月销售额百分比
	private String webmark;//地图标注
	private Integer webcheck;//发帖登记
	private Integer webyear;//年
	private Integer webmonth;//月
	private String bsc011;//门店代码
	private Double webmoney;//当月销售额
	private String webname;//
	private String webcall;//
	private String webintro;//
	private String webfrom;//
	private String websc;//判断是本店销售还是转至其他惠耳店
	private String webcommit;//
	...
	public Integer getWebsell() {
		return websell;
	}

	public void setWebsell(Integer websell) {
		this.websell = websell;
	}
	...
	public Double getWebcvt() {
		return webcvt;
	}

	public void setWebcvt(Double webcvt) {
		this.webcvt = webcvt;
	}

	public Double getWeblocal() {
		return weblocal;
	}

	public void setWeblocal(Double weblocal) {
	...
	public void setWebrate(Double webrate) {
	...
	public void setWebmark(String webmark) {
		this.webmark = webmark;
	}

	public Integer getWebcheck() {
		return webcheck;
	}

	public void setWebcheck(Integer webcheck) {
		this.webcheck = webcheck;
	}

	public Integer getWebyear() {
		return webyear;
	}

	public void setWebyear(Integer webyear) {
		this.webyear = webyear;
	}

	public Integer getWebmonth() {
		return webmonth;
	}

	public void setWebmonth(Integer webmonth) {
		this.webmonth = webmonth;
	}
	...
	public String getWebsc() {
		return websc;
	}

	public void setWebsc(String websc) {
		this.websc = websc;
	}

	public String getWebcommit() {
		return webcommit;
	}

	public void setWebcommit(String webcommit) {
