...
public class QAForm extends ActionForm {
	...
	private String qastatus; // 质检状态(等待质检、质检完成)
	...
	//2017-9-21增加电声性能，安全性能
	private String qatestsound;//电声性能
	private String qatestsafe;//安全性能
	
	//2018-5-29质检设备
	private String qadev;//质检设备
	private String gctnm;//店铺名称
	...
	public String getQadev() {
		return qadev;
	}

	public void setQadev(String qadev) {
		this.qadev = qadev;
	}

	public String getQatestsound() {
		return qatestsound;
	}

	public void setQatestsound(String qatestsound) {
		this.qatestsound = qatestsound;
	}

	public String getQatestsafe() {
		return qatestsafe;
	}

	public void setQatestsafe(String qatestsafe) {
		this.qatestsafe = qatestsafe;
	}
	...
	private String qashellele;//外壳漏电流
	private String qaeledc;//患者漏电流dc
	private String qaeleac;//患者漏电流ac

	public String getQashellele() {
		return qashellele;
	}

	public void setQashellele(String qashellele) {
		this.qashellele = qashellele;
	}

	public String getQaeledc() {
		return qaeledc;
	}

	public void setQaeledc(String qaeledc) {
		this.qaeledc = qaeledc;
	}

	public String getQaeleac() {
		return qaeleac;
	}

	public void setQaeleac(String qaeleac) {
		this.qaeleac = qaeleac;
	}
