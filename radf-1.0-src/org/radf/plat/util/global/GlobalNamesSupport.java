...
public class GlobalNamesSupport {
    ...
    public static String DATABASE_URL = "jdbc:oracle:thin:@10.1.18.222:1521:orcl";
    /**数据库连接用户，DATABASE_CONNECT_TYPE = "2"有效*/
    public static String DATABASE_USER = "huier";
    /**数据库连接用户密码，DATABASE_CONNECT_TYPE = "2" 有效*/
    public static String DATABASE_PASSWORD = "oracle1";
    
    /**数据库连接URL，DATABASE_CONNECT_TYPE = "2"有效*/
    public static String DATABASE_URL2 = "jdbc:oracle:thin:@10.1.18.222:1521:orcl";
    /**数据库连接用户，DATABASE_CONNECT_TYPE = "2"有效*/
    public static String DATABASE_USER2 = "huier";
    /**数据库连接用户密码，DATABASE_CONNECT_TYPE = "2" 有效*/
    public static String DATABASE_PASSWORD2 = "oracle1";
    /**huiermall的地址，这个地方只是默认的，需要求该请在TZSW_Config修改*/
    public static String HUIERMALL_LINK = "http://localhost:8080/huiermall/services/testwebservice";
    ...
    /**分页组件商品管理修改配置的分页大小*/
    public static int PAGE_SIZE2 = 20;
    /**客户端版本更新时每次下载数据的条数**/
  ...
  //3D附件存储相关变量
  	...
  	public static String SERVER_1_PAN = "D";
  	
  	public static String SERVER_1_DIR = "3DFiles";

  	public static String SERVER_2_PAN = "D";
  	
  	public static String SERVER_2_DIR = "3DFile";
    /**
