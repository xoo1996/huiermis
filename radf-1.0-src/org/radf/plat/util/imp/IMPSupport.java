...
public class IMPSupport implements FACADESupport{
    ...
    public ResponseEnvelop findBySQL2(RequestEnvelop request) {
        return findBySQL2(request,null,"findBySQL",0);
    }
    public ResponseEnvelop getCount(RequestEnvelop request) {
        return getCount(request,null,"getCount",0);
    }
    public ResponseEnvelop getCount2(RequestEnvelop request) {
        return getCount2(request,null,"getCount",0);
    }
    ...
    protected ResponseEnvelop findBySQL2(RequestEnvelop request,BPOSupport bpo,String method,int nErrorCode){
        ResponseEnvelop response = new ResponseEnvelop();
        Connection con = null;
        try {
            HashMap mapRequest=(HashMap)request.getBody();
    ...
    protected ResponseEnvelop getCount2(RequestEnvelop request,BPOSupport bpo,String method,int nErrorCode){
        ResponseEnvelop response = new ResponseEnvelop();
        Connection con = null;
        try {
            // 得到从request中的HashMap
