...
//              curVector.add(attrs.getValue(paraName));
    ...
    private void loadConfig(HashMap map){
        try {
            ...
            GlobalNames.DATABASE_URL2 = (String) map.get("DATABASE_URL2");
            GlobalNames.DATABASE_USER2 = (String) map.get("DATABASE_USER2");
            GlobalNames.DATABASE_PASSWORD2 = (String) map.get("DATABASE_PASSWORD2");
            GlobalNames.HUIERMALL_LINK = (String) map.get("HUIERMALL_LINK");
            ...
            //3D附件存储相关变量
            GlobalNames.SERVER_1_PAN = (String)map.get("SERVER_1_PAN");
            GlobalNames.SERVER_1_DIR = (String)map.get("SERVER_1_DIR");
            GlobalNames.SERVER_2_PAN = (String)map.get("SERVER_2_PAN");
            GlobalNames.SERVER_2_DIR = (String)map.get("SERVER_2_DIR");
            GlobalNames.SERVER_2_IP = (String)map.get("SERVER_2_IP");
            GlobalNames.SERVER_2_PORT = (String)map.get("SERVER_2_PORT");
            GlobalNames.FTP_USER = (String)map.get("FTP_USER");
            GlobalNames.FTP_PASSWORD = (String)map.get("FTP_PASSWORD");
            //应用的根路径
