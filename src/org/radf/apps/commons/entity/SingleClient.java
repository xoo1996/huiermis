...
public class SingleClient extends EntitySupport {
	...
	private Date start; // 复诊日期
	private Date end; // 复诊日期
	...
	//新增复诊声场
		private String fcscid;//复诊言语评估编号
