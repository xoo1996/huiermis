...
//收费基本信息表
public class Charge extends EntitySupport {
...
//	private String chgstoid; //库存编号
	...
	private Integer ncdrnt;
	private String pdtut;//商品单位
	
	private Double tdspvo;//省内外最小扣率
	private String mindisi;
	private String ncdisspdisc; // 商品售出备注
	...
	//机身编号
	private String pdtxh;
	private Double pdtyj;
	private Double pdtyouhui;
	private String jsid;
	...
	public Integer getNcdrnt() {
		return ncdrnt;
	}
	public void setNcdrnt(Integer ncdrnt) {
		this.ncdrnt = ncdrnt;
	}
	...
	public Double getNcdrecmon() {
		return ncdrecmon;
	}
	public void setNcdrecmon(Double ncdrecmon) {
		this.ncdrecmon = ncdrecmon;
	}
	...
	public String getMindisi() {
		return mindisi;
	}
	public void setMindisi(String mindisi) {
		this.mindisi = mindisi;
	}
	public String getNcdisspdisc() {
		return ncdisspdisc;
	}
	public void setNcdisspdisc(String ncdisspdisc) {
		this.ncdisspdisc = ncdisspdisc;
	}
	...
	public Date getNcdrecexadt() {
		return ncdrecexadt;
	}
	public void setNcdrecexadt(Date ncdrecexadt) {
		this.ncdrecexadt = ncdrecexadt;
	}
	...
	public String getPdtxh() {
		return pdtxh;
	}
	public void setPdtxh(String pdtxh) {
		this.pdtxh = pdtxh;
	}
	public Double getPdtyj() {
		return pdtyj;
	}
	public void setPdtyj(Double pdtyj) {
		this.pdtyj = pdtyj;
	}
	public Double getPdtyouhui() {
		return pdtyouhui;
	}
	public void setPdtyouhui(Double pdtyouhui) {
		this.pdtyouhui = pdtyouhui;
	}
