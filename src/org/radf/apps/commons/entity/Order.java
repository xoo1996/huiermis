...
public class Order extends EntitySupport {
	...
	private Date foldt; // 日期
	private String foldctime; //具体日期
	private String folopr; // 操作员代码
	...
	private String fdtcltnm;// 订单详细个人客户姓名
	private String folctnm;
	private Date fdtexadt;// 退机审核日期
	private String fdtres;// 退机原因
	private String fdtfno;// 订单号
	private String fdtono;// 原来订单号
	private Date folexdt;// 审核日期
	...
	public String getFolfile() {
		return folfile;
	}

	public void setFolfile(String folfile) {
	...
	public String getFdtres() {
		return fdtres;
	}

	public void setFdtres(String fdtres) {
		this.fdtres = fdtres;
	}

	public String getFoldctime() {
		return foldctime;
	}

	public void setFoldctime(String foldctime) {
		this.foldctime = foldctime;
	}
