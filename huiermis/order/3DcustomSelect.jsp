...
<script language="javascript">	
	...
	function add() {
		...
		//+ "/order/CustomOrderAction.do?method=inputOrder&tp=cus&"
		+ "/order/OrderAction.do?method=printClient&tp=3DCus&"
	...
	function addClient(obj) {
		...
		window.location.href = "/" + lemis.WEB_APP_NAME
		+ "/order/CustomOrderAction.do?method=forwardClient&tp=cus&ictnm=" + $("input[name=ictnm]").val();
	}; 
...
<lemis:body>
	...
	<lemis:query action="/CustomOrderAction.do?method=queryClient&tp=3Dcus"
