...
<%
	...
	buttons.add(new Button("export","导出","ord150200","exportExcel(document.forms[0])"));
...
function exportExcel(obj) {
	if (confirm("即将导出当日审核通过记录")) {
	obj.action = '<html:rewrite href="/huiermis/charge/ChargeAction.do?method=exportDingZhiVerifyPass"/>';
	obj.submit();
	}
};
