...
/* 	List<Button> buttons=new ArrayList<Button>();
	...
	buttons.put("订单详情","detail(document.all.tableform)");
...
<script language="javascript">
	...
	function detail(obj) {
		...
		obj.action = '<html:rewrite page="/OrderAction.do?method=orderDetail&tp2=s&"/>'+getAlldata(obj)+ "&foltype=make";			
		obj.submit();
...
<lemis:body>
	...
	<lemis:table action="OrderAction.do" headerMeta="header" topic="订单信息"
		...
		<input type='hidden' name="foltype" id="foltype" value="make">
