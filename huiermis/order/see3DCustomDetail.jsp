...
<!-- <script src="/huiermis/js/inputDetail.js"> -->
 <script language="javascript">
	 $(document).ready(function(){
		 var folno1 = $('input[name=folno]').val();
		 $("#download").attr("href","/huiermis/order/OrderAction.do?method=downloadFile&folno2=" + folno1);
	 });
	...
	<table class="tableInput">
		...
		<lemis:tabletitle title="左耳骨导" />
	 	 ...
	 	 <lemis:tabletitle title="右耳" />
            ...
            <lemis:editorlayout />
             <tr>
				<td>附件</td><td><a id="download" href="" >点击下载</a></td> <td></td><td></td><td></td><td></td>
            </tr>
