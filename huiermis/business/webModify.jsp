...
<%
    ...
    buttons.put("修 改","saveData(document.forms[0])");
...
<lemis:body>
<lemis:base />
    <lemis:title title="网络销售来源数据修改" />
	<lemis:tabletitle title="网络销售来源信息" />
	<table class="tableinput">
		<lemis:editorlayout />
		<html:form action="/BusinessAction.do?method=updateWebSell" method="POST">
			<tr>
				<lemis:texteditor property="gctnm" label="所属团体" disable="true" required="true"  />	
				<lemis:texteditor property="gctarea" label="所属区域" disable="true" required="true" />
			</tr>
			<tr>
