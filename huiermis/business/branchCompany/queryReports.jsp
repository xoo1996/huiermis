...
<lemis:base />
<lemis:body>
	<lemis:title title="分公司情况信息表" />
	 <lemis:tabletitle title="导出分公司情况信息表" />
	<table class="TableInput">
		<lemis:editorlayout />
		<html:form action="/BranchFinancialAction.do?method=exportReport" method="POST">
			<tr>
				<lemis:texteditor property="startyear" required="true" label="开始年份"
			...
			<tr>
				...
				<lemis:texteditor property="gctid" required="false" label="客户名称"
	...
	<div align="right">
		<input type="button" name="openwin" value="&nbsp;导&nbsp;&nbsp;出&nbsp;" class='buttonGray' onclick=print(document.forms[0]);;>
