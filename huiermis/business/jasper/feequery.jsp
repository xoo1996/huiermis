...
<script language="javascript">
	function print(obj) {
		...
		obj.action='<html:rewrite page="/FeeAction.do?method=companyfee&"/>' + getAlldata(obj);
		obj.submit();
	};
	function printNew(obj) {
		if (!checkValue(obj)) {
			return false;
		}
		obj.action='<html:rewrite page="/FeeAction.do?method=companyfeeNew&"/>' + getAlldata(obj);
		obj.submit();
	};
...
<lemis:body>
	...
	<input type="button"
		...
		onclick=printNew(document.forms[0]);;> 
	<input type="button"
		name="openwin" value="打印(旧)" class='buttonGray'
