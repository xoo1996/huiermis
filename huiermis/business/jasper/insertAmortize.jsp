...
<script language="javascript">
	...
	//	obj.action = encodeURI('<html:rewrite page="/FeeAction.do?method=setAmortize&"/>'+getAlldata(document.all.tableform));
			
	if (confirm("确实要录入订单并提交吗？")) {
		window.location.href = "/" + lemis.WEB_APP_NAME + "/business/FeeAction.do?method=setAmortize&" + getAlldata(document.all.tableform) +"&feegctid=" + $("input[name=feegctid]").val() + "&feegctname=" + $("input[name=feegctname]").val(); 
	}
};
</script>
