...
/*  		$("input[name=ivttry]").bind("blur", function(e) {
	...
	function batchSubmit(obj) {
		...
		obj.action = '<html:rewrite page="/BusinessAction.do?method=batchSubmitOnly&year="/>' + $("input");
		obj.submit();
...
<script language="javascript">
	...
	function back(obj){
		obj.action='<html:rewrite page="/BusinessAction.do?method=findyuejie&mark=back"/>';
		obj.submit();
	};
...
<lemis:body>
	...
	<lemis:query action="/BusinessAction.do?method=yuejieEdit&mark=jiameng"
