...
<%			String stringData = "";
			...
			buttons.put("初始化Ukey","iniKey()");
			buttons.put("启用", "openKey(document.all.tableform)");
			buttons.put("停用", "closeKey(document.all.tableform)");
			buttons.put("全部启用","openAll()");
			buttons.put("全部停用","closeAll()");
