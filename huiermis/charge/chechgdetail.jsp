	...
	function save() {
		...
		if (confirm("确实要收费吗？")) {
			...
			window.location.href = "/" + lemis.WEB_APP_NAME
					+ "/charge/ChargeAction.do?method=saveCheckCharge&" +
...
<script>
	...
	function compute1(e) {
		...
		var value = $("#fdtqnt" + suffix).val() * $("#fdtprc" + suffix).val();
