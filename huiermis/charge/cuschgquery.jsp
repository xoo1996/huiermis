...
<%
	...
	header.add(new Formatter("fdtcltid", "个人客户编号"));
	...
	buttons.put("会员补录","bulu(document.all.tableform)");
	...
	hidden.put("fdtcltid","个人客户编号");
	hidden.put("pdtid","商品代号");
...
<script language="javascript">
	function bulu(obj){
		...
		obj.action = '<html:rewrite page="/ChargeAction.do?method=addcusmember&"/>' + getAlldata(obj);
		obj.submit();
	};
	...
	function print(obj) {
		...
		obj.action = '<html:rewrite page="/ChargeAction.do?method=print2&"/>' + getAlldata(obj);
		obj.submit();
	};
