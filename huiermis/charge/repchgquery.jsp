...
<script language="javascript">
	...
	function print(obj) {
		...
		obj.action = '<html:rewrite page="/ChargeAction.do?method=print3&type=re&"/>' + getAlldata(obj);
		obj.submit();
	};
</script>
