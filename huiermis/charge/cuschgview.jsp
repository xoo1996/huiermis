...
<%-- 			<tr>
				<lemis:texteditor  property="bm"  label="赠送电池型号"
					disable="true" required="false" value="<%=bm %>"/>
				<lemis:texteditor  property="gby"  label="赠送电池数"
					disable="true" required="false" value="<%=gby %>"/>
			</tr> --%>
			<tr>
