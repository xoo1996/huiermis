...
<%
	...
	header.add(new Formatter("ncdid", "收费流水号",TagConstants.DF_CENTER));
	header.add(new Formatter("ncdpid", "商品名称",TagConstants.DF_CENTER));
	header.add(new Formatter("ncdqnt", "售出数量",TagConstants.DF_CENTER));
	header.add(new Formatter("ncddis", "扣率",TagConstants.DF_CENTER));
	header.add(new Formatter("ncdmon", "实际收费",TagConstants.DF_CENTER));
	header.add(new Formatter("ncdnt", "备注",TagConstants.DF_CENTER));
