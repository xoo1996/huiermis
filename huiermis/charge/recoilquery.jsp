...
/* 	header.add(new Formatter("chgrecdt", "退机日期"));
	...
	//新增
	buttons.put("会员补录","bulu(document.forms[0])");
...
function bulu(obj) {
	...
	obj.action='<html:rewrite href="/huiermis/charge/ChargeAction.do?method=addnormember&"/>'+ getAlldata(document.all.tableform);
	obj.submit();
};
