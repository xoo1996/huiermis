...
<%
	...
	buttons.put("优惠收费","shoufei(document.all.tableform)");
...
<script language="javascript">
	...
	function shoufei(obj) {
		...
		obj.action = '<html:rewrite page="/ChargeAction.do?method=saveChgid&tp=youhui&"/>' + getAlldata(obj);
		obj.submit();
	};
	function news(obj) {
...
<lemis:body>
	...
	<lemis:query action="/ChargeAction.do?method=clientQuery&tp=youhui" editorMeta="editor" topic="查询条件" />	
