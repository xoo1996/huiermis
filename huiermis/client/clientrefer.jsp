...
<script language="javascript">
	$(document).ready(function(){
		...
		{
			$("input[name=rsvgctzhuannm]").val("<%=dto.getBsc012()%>");
			$("input[name=rsvgctzhuannm]").attr("readonly","true");
...
<lemis:body>
	...
	<lemis:query action="/ReservationAction.do?method=yuyuequery&action=zhuangzhen"
