...
<lemis:body>
		<lemis:base />
		<lemis:errors />
		<lemis:title title="惠耳售后服务调查表修改" />
		<lemis:tabletitle title="用户基本信息信息" />
		<table class="tableinput">
			<lemis:editorlayout />
			<html:form action="/SingleClientAction.do?method=addBV&type=update" method="POST">
			<html:hidden property="bvid" />  
				<tr>
				...
				<tr>
					<lemis:codelisteditor type="bvmethod1" isSelect="true" label="回访方法" redisplay="true" required="false" />
					<lemis:codelisteditor type="bveffect1" isSelect="true" label="效果评定" redisplay="true" required="false" />
				</tr>
				<tr>
					<lemis:texteditor property="bvvisitor1" label="回访者" required="false" disable="false" />
					<lemis:formateditor mask="date" property="bvdate1" required="false" label="回访日期" disable="false" format="true"/>				
				</tr>	
				</table>
