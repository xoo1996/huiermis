...
<lemis:body>
	...
	<table class="tableInput">
		<lemis:editorlayout />
		<html:form action="/SingleClientAction.do?method=addClient1&type=1"
			method="POST">
			<tr>
				<html:hidden property="ictid" />
				<lemis:texteditor property="ictgctid" label="所属团体" disable="false"
					required="true" />
				<lemis:texteditor property="ictnm" label="用户姓名" disable="false"
					required="true" />
			...
			<select style='font-size:12px' name='ictcounty' id='ictcounty'
				...
				<lemis:texteditor property="ictdetailaddr" label="详细地址" disable="false"
				required="true" />

				<lemis:codelisteditor type="ictphis" label="使用过何种助听器"
				required="true" />
			...
			<tr>
				...
				<lemis:formateditor property="ictcard" label="身份证号" disable="false"
