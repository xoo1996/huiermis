...
$(document).ready(function(){	
	...
	$("textarea[name=debugrecord]").css("width","800px");
...
<lemis:body>
		...
		<html:form action="/SingleClientAction.do?method=addSCTL" method="POST">
			...
			<tr>
				<lemis:texteditor property="ictnm" label="用户姓名" required="false"
					...
					disable="true" />
					<tr>
				<lemis:texteditor property="bvlefttype" label="左耳助听器型号"
					required="false" disable="true" />
				<lemis:texteditor property="bvleftnum" label="左耳助听器机身编号"
					required="false" disable="true" />
			</tr>
			<tr>
				<lemis:texteditor property="bvrighttype" label="右耳助听器型号"
					required="false" disable="true" />
				<lemis:texteditor property="bvrightnum" label="右耳助听器机身编号"
					required="false" disable="true" />
			</tr>
					<lemis:formateditor mask="date" format="true" property="fctcdt" label="复诊日期"
			...
			<lemis:tabletitle title="调试记录" />
				<table class="tableinput">
				
					<html:textarea cols="2" property="debugrecord" rows="2" disabled="true"/>
				</table>
				
            <%-- <lemis:tabletitle title="调试记录" />
			<tr>
			<html:textarea property="debugrecord" disabled="true" cols="150" rows="2"></html:textarea>
            </tr> --%>
			...
			<table class="tableinput">
				<tr>
					...
					<td width="5px"><html:checkbox  property="lgyb250"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lg500" label="500" required="false"
						disable="true" onblur="lgvag()" colspan="1"/>
					<td width="5px"><html:checkbox  property="lgyb500"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lg750" label="750" required="false"
						disable="true" onblur="lgvag()" />
					<td width="5px"><html:checkbox  property="lgyb750"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lg1000" label="1000" required="false"
						disable="true" onblur="lgvag()" />
					<td width="10px"><html:checkbox  property="lgyb1000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lg1500" label="1500" required="false"
						disable="true" onblur="lgvag()" />
					<td width="10px"><html:checkbox  property="lgyb1500"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lg2000" label="2000" required="false"
						disable="true" onblur="lgvag()" />
					<td width="10px"><html:checkbox  property="lgyb2000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lg3000" label="3000" required="false"
						disable="true" onblur="lgvag()" />
				    <td width="10px"><html:checkbox  property="lgyb3000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lg4000" label="4000" required="false"
						disable="true" onblur="lgvag()" />
					<td width="10px"><html:checkbox  property="lgyb4000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lg6000" label="6000" required="false"
						disable="true" onblur="lgvag()" />
					<td width="10px"><html:checkbox  property="lgyb6000"  value="1" disabled="true" /></td>
			...
			<table class="tableinput">
				<tr>
					<lemis:texteditor property="lq250" label="250" required="false"
						disable="true" onblur="lqvag()"/>
					<td width="5px"><html:checkbox  property="lqyb250"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lq500" label="500" required="false"
						disable="true" onblur="lqvag()" colspan="1"/>
					<td width="5px"><html:checkbox  property="lqyb500"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lq750" label="750" required="false"
						disable="true" onblur="lqvag()" />
					<td width="5px"><html:checkbox  property="lqyb750"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lq1000" label="1000" required="false"
						disable="true" onblur="lqvag()" />
					<td width="10px"><html:checkbox  property="lqyb1000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lq1500" label="1500" required="false"
						disable="true" onblur="lqvag()" />
					<td width="10px"><html:checkbox  property="lqyb1500"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lq2000" label="2000" required="false"
						disable="true" onblur="lqvag()" />
					<td width="10px"><html:checkbox  property="lqyb2000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lq3000" label="3000" required="false"
						disable="true" onblur="lqvag()" />
				    <td width="10px"><html:checkbox  property="lqyb3000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lq4000" label="4000" required="false"
						disable="true" onblur="lqvag()" />
					<td width="10px"><html:checkbox  property="lqyb4000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="lq6000" label="6000" required="false"
						disable="true" onblur="lqvag()" />
					<td width="10px"><html:checkbox  property="lqyb6000"  value="1" disabled="true" /></td>
			...
			<tr>
					...
					<td width="5px"><html:checkbox  property="rgyb250"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rg500" label="500" required="false"
						disable="true" onblur="rgvag()" colspan="1"/>
					<td width="5px"><html:checkbox  property="rgyb500"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rg750" label="750" required="false"
						disable="true" onblur="rgvag()" />
					<td width="5px"><html:checkbox  property="rgyb750"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rg1000" label="1000" required="false"
						disable="true" onblur="rgvag()" />
					<td width="10px"><html:checkbox  property="rgyb1000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rg1500" label="1500" required="false"
						disable="true" onblur="rgvag()" />
					<td width="10px"><html:checkbox  property="rgyb1500"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rg2000" label="2000" required="false"
						disable="true" onblur="rgvag()" />
					<td width="10px"><html:checkbox  property="rgyb2000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rg3000" label="3000" required="false"
						disable="true" onblur="rgvag()" />
				    <td width="10px"><html:checkbox  property="rgyb3000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rg4000" label="4000" required="false"
						disable="true" onblur="rgvag()" />
					<td width="10px"><html:checkbox  property="rgyb4000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rg6000" label="6000" required="false"
						disable="true" onblur="rgvag()" />
					<td width="10px"><html:checkbox  property="rgyb6000"  value="1" disabled="true" /></td>
			...
			<table class="tableinput">
				<tr>
					<lemis:texteditor property="rq250" label="250" required="false"
						disable="true" onblur="rqvag()"/>
					<td width="5px"><html:checkbox  property="rqyb250"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rq500" label="500" required="false"
						disable="true" onblur="rqvag()" colspan="1"/>
					<td width="5px"><html:checkbox  property="rqyb500"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rq750" label="750" required="false"
						disable="true" onblur="rqvag()" />
					<td width="5px"><html:checkbox  property="rqyb750"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rq1000" label="1000" required="false"
						disable="true" onblur="rqvag()" />
					<td width="10px"><html:checkbox  property="rqyb1000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rq1500" label="1500" required="false"
						disable="true" onblur="rqvag()" />
					<td width="10px"><html:checkbox  property="rqyb1500"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rq2000" label="2000" required="false"
						disable="true" onblur="rqvag()" />
					<td width="10px"><html:checkbox  property="rqyb2000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rq3000" label="3000" required="false"
						disable="true" onblur="rqvag()" />
				    <td width="10px"><html:checkbox  property="rqyb3000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rq4000" label="4000" required="false"
						disable="true" onblur="rqvag()" />
					<td width="10px"><html:checkbox  property="rqyb4000"  value="1" disabled="true" /></td>
						
					<lemis:texteditor property="rq6000" label="6000" required="false"
						disable="true" onblur="rqvag()" />
					<td width="10px"><html:checkbox  property="rqyb6000"  value="1" disabled="true" /></td>
	...
	<table id="iframediv" border="0">
		<tr>
			<td><iframe
				src='<html:rewrite page="/DiagnoseAction.do?method=showLeft1"/>'
				id="iframe1" name="iframe1" height="320"
				frameborder="0" width="100%"></iframe></td>
			<td><iframe
				src='<html:rewrite page="/DiagnoseAction.do?method=showRight1"/>'
