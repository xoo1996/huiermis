...
function lsvag() {
	...
	//var lvag = (palseInt(l1) + palseInt(l2) + palseInt(l3) + palseInt(l4) + palseInt(l5))/5;
 var lvag = (palseInt(l2) + palseInt(l3) + palseInt(l4))/3;
	...
	<table class="tableinput">
		...
		<html:form action="/SingleClientAction.do?method=showdetail"
			...
			<tr>
				...
				<lemis:formateditor property="ictcard" label="身份证号" disable="true"
