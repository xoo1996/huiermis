	...
	<table class="tableinput">
		...
		<html:form action="/QAAction.do?method=saveModified" method="POST">
			...
			<table class="tableinput">
				...
				<tr>
					<lemis:texteditor property="qatest11" label="高频平均声输出(检2)" required="true"
						disable="true" />
					<lemis:texteditor property="qatest3" label="高频平均声增益(检2)" required="false"
						disable="true" />
				...
				<lemis:texteditor property="qashellele" label="外壳漏电流（不大于0.1mA）" required="true"
					disable="true" />
				<lemis:texteditor property="qaeledc" label="患者漏电流dc（不大于0.01mA）" disable="true"
					required="true" />
				<lemis:texteditor property="qaeleac" label="患者漏电流ac（不大于0.1mA）" disable="true"
					required="true" />
				</tr>
				<tr>
					<lemis:codelisteditor type="qatestsound" label="电声性能" isSelect="false"
					required="true" />
					<lemis:codelisteditor type="qatestsafe" label="安全性能" isSelect="false"
					required="true" />
					<lemis:codelisteditor type="qachk" label="检验结果" isSelect="false"
					required="true" />
				</tr>
				<tr>
