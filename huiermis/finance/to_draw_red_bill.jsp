...
<%	
	...
	header.add(new Formatter("redt", "退机日期"));
	...
	batchInput.add(new Editor("text", "invoicecode", "发票代码", "true"));
    batchInput.add(new Editor("text", "invoiceno", "发票编号", "true"));
...
<lemis:base />
<lemis:body>
	<lemis:title title="普通和定制商品开发票" />
	<lemis:query action="/FinanceAction.do?method=queryToDrawRedBill" editorMeta="editor"
		topic="查询条件" />
