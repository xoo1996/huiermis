...
<%	
	...
	hidden.put("retailname", "发票抬头");
	hidden.put("retailtaxno", "发票税号");
...
<lemis:base />
<lemis:body>
	<lemis:title title="普通和定制商品开专用发票" />
	<lemis:query action="/FinanceAction.do?method=queryToDrawSpecialBill" editorMeta="editor"
		topic="查询条件" />
