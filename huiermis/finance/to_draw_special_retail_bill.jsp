...
<%	
	...
	header.add(new Formatter("comaddr", "公司地址"));
	header.add(new Formatter("depositbank", "开户行"));
	header.add(new Formatter("depositid", "开户账号"));
	header.add(new Formatter("specialtel", "电话"));
...
/* 	editors.add(new Editor("text", "fintel", "开票人电话")); */
    ...
    batchInput.add(new Editor("text", "comaddr", "公司地址", "true"));
    batchInput.add(new Editor("text", "depositbank", "开户行", "true"));
    batchInput.add(new Editor("text", "depositid", "开户账号", "true"));
    batchInput.add(new Editor("text", "specialtel", "专用电话", "true"));
...
<lemis:base />
<lemis:body>
	<lemis:title title="普通和定制商品开专用发票（零售）" />
