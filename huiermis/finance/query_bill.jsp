...
<%	
	...
	buttons.put("生成普通订单编号(进货)","creinfo(document.all.tableform)");
	buttons.put("生成普通订单编号(零售)","creretailinfo(document.all.tableform)");
	buttons.put("生成专用订单编号(进货)","crespecialinfo(document.all.tableform)");
	buttons.put("生成专用订单编号(零售)","cresperetailinfo(document.all.tableform)");
	...
	editors.add(new Editor("text", "fintype2", "开票类型"));
	editors.add(new Editor("text", "notype", "订单类型"));
	editors.add(new Editor("text", "gctnm", "店铺名称"));
	editors.add(new Editor("text", "ictnm", "个人姓名"));
